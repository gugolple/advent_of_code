...
fn recurse(tree: &HashMap<String, Vec<String>>, vals: &HashMap<String, u64>, seen: &mut HashMap<(String, i64, u64), u64>, open: &mut HashSet<String>, node: &str, rem: i64, score: u64) -> u64 {
...
fn process_input(input: &str) -> u64 {
    ...
    println!("Tree: {:?}", tree);
    println!("Vals: {:?}", vals);
    let rec =  recurse(&tree, &vals, &mut HashMap::new(), &mut HashSet::new(), "AA", 30, 0);
...
Valve JJ has flow rate=21; tunnel leads to valve II";
        assert_eq!(process_input(input),1651);
    }
}
